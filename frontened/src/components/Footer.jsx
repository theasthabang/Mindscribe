...
function Footer() {
          ...
          style={{ transformStyle: "preserve-3d" }}>
            ...
            style={{ transform: "translateZ(20px)" }}>
              ...
              style={{ textShadow: "0 6px 18px rgba(0,0,0,0.4)" }}>
                 Mindscribe <span className="text-gray-400">AI</span>
              </span>

            </div>
            <p className="text-sm text-gray-300 max-w-sm">Mindscribe AI helps students generate exam-focused notes,
 ...
 <div className='text-center'>
            ...
            <ul className='space-y-2 text-sm'>
                ...
                <li className='text-gray-300 hover:text-white transition-colors'>support@Mindscribe.com</li>
            </ul>
        </div>
     ...
     <p className='text-center text-xs text-gray-500'>
        © {new Date().getFullYear()} Mindscribe AI. All rights reserved.
     </p>
