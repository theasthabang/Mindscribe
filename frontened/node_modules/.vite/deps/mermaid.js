import { a as setLogLevel, i as log, r as __name, t as select_default } from "./src-Crp46lJu.js";
import { F as reset, G as setSiteConfig, H as setConfig, J as styles_default, M as registerDiagram, N as registerLazyLoadedDiagrams, S as getDiagramLoader, T as getSiteConfig, X as updateSiteConfig, Y as themes_default, Z as purify, c as configureSvgSize, f as detectType, g as frontMatterRegex, h as evaluate, l as defaultConfig, n as addDirective, p as detectors, r as assignWithDepth_default, t as UnknownDiagramError, w as getEffectiveHtmlLabels, x as getDiagram, y as getConfig, z as saveConfigFromInitialize } from "./chunk-ICPOFSXX-wCrs4Lof.js";
import { a as encodeEntities, d as isDetailedError, h as utils_default, i as decodeEntities, m as removeDirectives, r as cleanAndMerge } from "./chunk-5PVQY5BW-CWVQjzlJ.js";
import { t as selectSvgElement } from "./chunk-426QAEUC-BcPbtglu.js";
import { n as load, t as JSON_SCHEMA } from "./chunk-XPW4576I-AsuU5_CB.js";
import "./chunk-BSJP7CBP-B_gmthRg.js";
import "./chunk-ZZ45TVLE-BTS125GK.js";
import "./chunk-X2U36JSP-DEA9M6Qi.js";
import { i as registerIconPacks, o as dedent } from "./chunk-U2HBQHQK-CoKsaFAJ.js";
import "./chunk-5FUZZQ4R-YLL_CgAA.js";
import "./chunk-ENJZ2VHE-DyYiuUO7.js";
import { n as registerLayoutLoaders } from "./chunk-336JU56O-CtnyhcD-.js";
import { t as isEmpty } from "./isEmpty-BxDRzMZd.js";
...
var c4Detector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./c4Diagram-AHTNJAMY-KS8QIunT.js");
		return {
			id,
			diagram: diagram2
		};
...
var flowDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./flowDiagram-DWJPFMVM-D9656GtA.js");
		return {
			id: id2,
			diagram: diagram2
		};
...
var erDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./erDiagram-SMLLAGMA-_qcXm9dE.js");
		return {
			id: id4,
			diagram: diagram2
		};
...
var gitGraphDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./gitGraphDiagram-UUTBAWPF-Cx2LOgmg.js");
		return {
			id: id5,
			diagram: diagram2
		};
...
var ganttDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./ganttDiagram-T4ZO3ILL-Dpcub0Ir.js");
		return {
			id: id6,
			diagram: diagram2
		};
...
var info = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./infoDiagram-42DDH7IO-Bmpq5lA4.js");
		return {
			id: id7,
			diagram: diagram2
		};
...
var pie = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./pieDiagram-DEJITSTG-CLrGv90I.js");
		return {
			id: id8,
			diagram: diagram2
		};
...
var quadrantDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./quadrantDiagram-34T5L4WZ-DBD5zaHc.js");
		return {
			id: id9,
			diagram: diagram2
		};
...
var xychartDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./xychartDiagram-5P7HB3ND-BRQTWeTa.js");
		return {
			id: id10,
			diagram: diagram2
		};
...
var requirementDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./requirementDiagram-MS252O5E-B8UG7hkW.js");
		return {
			id: id11,
			diagram: diagram2
		};
...
var sequenceDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./sequenceDiagram-FGHM5R23-CZPC7RHq.js");
		return {
			id: id12,
			diagram: diagram2
		};
...
var classDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./classDiagram-6PBFFD2Q-Bv3NTIx-.js");
		return {
			id: id13,
			diagram: diagram2
		};
...
var classDetector_V2_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./classDiagram-v2-HSJHXN6E-CHc3Vg2y.js");
		return {
			id: id14,
			diagram: diagram2
		};
...
var stateDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./stateDiagram-FHFEXIEX-CuftaAk7.js");
		return {
			id: id15,
			diagram: diagram2
		};
...
var stateDetector_V2_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./stateDiagram-v2-QKLJ7IA2-CuGIxi8Q.js");
		return {
			id: id16,
			diagram: diagram2
		};
...
var journeyDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./journeyDiagram-VCZTEJTY-BBpMMcVx.js");
		return {
			id: id17,
			diagram: diagram2
		};
...
var detector_default2 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./timeline-definition-GMOUNBTQ-ItX6MqNf.js");
		return {
			id: id19,
			diagram: diagram2
		};
...
var detector_default3 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./mindmap-definition-QFDTVHPH-DW_LXcOl.js");
		return {
			id: id20,
			diagram: diagram2
		};
...
var detector_default4 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./kanban-definition-6JOO6SKY-CI4r0d72.js");
		return {
			id: id21,
			diagram: diagram2
		};
...
var sankeyDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./sankeyDiagram-XADWPNL6-CS2DHhb8.js");
		return {
			id: id22,
			diagram: diagram2
		};
...
var packet = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-TYMM5635-Cb-qrkY8.js");
		return {
			id: id23,
			diagram: diagram2
		};
...
var radar = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-MMDJMWI5-BSUgb5xF.js");
		return {
			id: id24,
			diagram: diagram2
		};
...
var blockDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./blockDiagram-DXYQGD6D-VxDjV59G.js");
		return {
			id: id25,
			diagram: diagram2
		};
...
var detector_default5 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-5BDNPKRD-DjWmca-i.js");
		return {
			id: id26,
			diagram: diagram2
		};
...
var architectureDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./architectureDiagram-Q4EWVU46-CUhWTf2r.js");
		return {
			id: id27,
			diagram: diagram2
		};
...
var ishikawa = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./ishikawaDiagram-UXIWVN3A-BXCYoqUT.js");
		return {
			id: id28,
			diagram: diagram2
		};
...
var vennDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./vennDiagram-DHZGUBPP-D-UQL0up.js");
		return {
			id: id29,
			diagram: diagram2
		};
...
var treemap = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-G4DWMVQ6-LuHFL-u5.js");
		return {
			id: id30,
			diagram: diagram2
		};
...
var wardleyDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./wardleyDiagram-NUSXRM2D-rabysapI.js");
		return {
			id: id31,
			diagram: diagram2
		};
